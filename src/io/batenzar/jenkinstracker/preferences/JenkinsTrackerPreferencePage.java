...
public class JenkinsTrackerPreferencePage
	extends FieldEditorPreferencePage
	implements IWorkbenchPreferencePage {

	public JenkinsTrackerPreferencePage() {
		super(GRID);
...
////
		addField(
				new StringFieldEditor(PreferenceConstants.URL01, "URL 01:", getFieldEditorParent()));
		addField(
